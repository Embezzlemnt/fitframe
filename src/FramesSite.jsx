    ...
    <div className="app" style={{"--accent":ACCENT_COLOR}}>
      ...
      <div className="container">
        {step===0&&<div className="section">
          ...
          <div className="founder-card"><div className="founder-avatar">LL</div><div><div className="founder-label">From Lorenzo</div><p>I work at a computer all day, and standard glasses have always been close but never right — tight at the temples, sliding down, or sitting crooked after a few hours. I started FitFrame because the problem was real in my own day, and the custom option I wanted did not exist at a price that made sense.</p><button className="btn btn-ghost" onClick={()=>setStep(1)}>Scan your face</button></div></div>
